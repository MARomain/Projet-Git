...
public class GameManagerTest : Singleton<GameManagerTest>
{
    ...
    private void SpawnPlayers()
    {
        for (int i = 0; i < Players.Length; i++)
        {
            Players[i].m_Instance =
                Instantiate(playerPrefab[i % playerPrefab.Length], m_SpawnPoint[i].position, m_SpawnPoint[i].rotation) as GameObject;
    ...
    private void Reset()
    {
        ...
        for (int i = 0; i < Players.Length; i++)
        {
            Players[i].m_Instance.transform.position = m_SpawnPoint[i].position;
            Players[i].m_Instance.transform.rotation = m_SpawnPoint[i].rotation;
        }
    }
